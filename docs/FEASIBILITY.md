# Bloody Roar II feasibility binding

## Identity

- Title and region: Bloody Roar II, USA.
- Serial: SCUS-94424.
- Source executable path: `disc/SCUS_944.24`.
- Load address: `0x8011E800`.
- Entry point: `0x80126174`.
- Source disc binding: `disc/Bloody Roar II (USA).cue`.
...
The clean source commit is `d2e00be01ead5f7b7dc833695f819f8019d16120`. It uses PSXRecomp
`eecf3b2a4ee3148f01f8f92b512930fd6307d82e` and recomp-ui `87bbf43c419c16b97bf433a84d600969159e2e84`. The source
contains 1010 non-comment seed rows.
...
- Source `game.toml`, `catalog_identity.json`, `VERSION`, and Git submodule
  entries at `d2e00be01ead5f7b7dc833695f819f8019d16120`.
- Portfolio `bloody-roar-ii/BUILDINFO.json`.
- Portfolio `bloody-roar-ii/RECEIPT.md`.
